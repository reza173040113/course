...
String finalToken;
class SearchDetailArea extends StatefulWidget {
  final String area;
  SearchDetailArea({@required this.area});

  @override
  _SearchDetailAreaState createState() => _SearchDetailAreaState();
}

class _SearchDetailAreaState extends State<SearchDetailArea> {
   var loading = false;
  List<dynamic> data;
  ...
  Future getData() async {
    ...
    final responseData = await http.get(
        "https://precampusgenerali.enzymeadvisinggroup.com/api2/api/v2/search?_limit=1000&_page=0&area='${widget.area}'",
        headers: headers);
